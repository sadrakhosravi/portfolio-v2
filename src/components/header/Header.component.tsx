...
const Header = (): JSX.Element => {
  ...
  return (
    <header
      className={`fixed inset-0 w-full flex justify-between items-center lg:px-6 sm:px-3 py-1 transition-all duration-300 ${
        !isScrolled && 'h-10'
      } ${isScrolled && 'bg-light-blue bg-opacity-5 h-8 blur-md drop-shadow-2xl'}`}
    >
